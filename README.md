...
![manager2-viewProducts](./screenshots/manager2-viewProducts.png)
### <a name="manager-view-low-inventory">View Low Inventory</a>
![manager3-viewLowInventory](./screenshots/manager3-viewLowInventory.png)
### <a name="manager-add-to-inventory">Add To Inventory</a>
![manager4-addToInventory](./screenshots/manager4-addToInventory.png)
### <a name="manager-add-new-product">Add New Product</a>
![manager5-addNewProduct](./screenshots/manager5-addNewProduct.png)
### <a name="manager-example-validation">Example of validation:</a>
![manager6-addNewProduct-validation](./screenshots/manager6-addNewProduct-validation.png)
